				...
				<tr>
					...
					<td>
							<div class="btn-group">
								...
								<a onclick="return confirm('Yakin?')" href="<?= base_url('admin/perumahan_del/').$pr['id_perumahan']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
								<a href="<?= base_url('admin/perumahan/edit/').$pr['id_perumahan']; ?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
							</div>
					</td>
				</tr>
				<?php endforeach; ?>
	...
	<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<?= base_url('admin/perumahan_add') ?>" method="post" enctype="multipart/form-data">
